...
namespace MvcContact {
   ...
   public class ContactInput {
      ...
      [EmailAddress(ErrorMessage = null, ErrorMessageResourceName = ContactResources.Keys.Validation_EmailPattern, ErrorMessageResourceType = typeof(ContactResources))]
      [Display(Order = 2)]
